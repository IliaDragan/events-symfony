...
class Category
{
     ...
     * Add children
     *
     * @param \IPG\EventsBundle\Entity\Category $children
     * @return Category
     */
    public function addChild(\IPG\EventsBundle\Entity\Category $children)
    {
     ...
     * @param \IPG\EventsBundle\Entity\Category $children
     */
    public function removeChild(\IPG\EventsBundle\Entity\Category $children)
    {
